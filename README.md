...
1.Calculator
 ...
 Features clean formatting and error handling for division by zero.

2.Password Generator
 A GUI application that creates strong, random passwords.
 Built with `Tkinter` using a custom skyblue theme.

3.Rock-Paper-Scissors
 A GUI game with real-time score tracking.
